(function (app) {
    ...
    // CREDIT: https://github.com/reidransom/timecode.js (extended to work for us: Benjamin)

    var timecodeProvider = {
        ...
        frameNumberToTimecode: function () {
            ...
            if (this.drop_frame) {
                ...
                if (this.hours > 23) {
                    ...
                    frame_count = frame_count - (24 * 3600 * this.int_framerate);
                }
    ...
    app.utility.timecodeProvider = timecodeProvider;   
